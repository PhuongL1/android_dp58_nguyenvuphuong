...
//        this.apiService = ApiClient.getClient().create(ApiService.class);
     ...
     */
    public synchronized boolean refreshToken() { //goi dong bo tren background
        ...
        try {
            ...
            if (response.isSuccessful() && response.body() != null && response.body().isSuccess()) {
                ...
                sharedPrefs.updateTokens(body.getAccessToken(), body.getRefreshToken()); //nho update vao dau thi de lay ra dung
                authManager.refreshToken(body.getAccessToken(), body.getRefreshToken());
